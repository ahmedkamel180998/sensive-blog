                    ...
                    <div class="navbar-collapse offset collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav justify-content-center">
                            <li class="nav-item @yield('home-active')"><a class="nav-link"
                                    href="{{ route('blog.index') }}">Home</a>
                            </li>
                            <li class="nav-item submenu dropdown @yield('categories-active')">
                                <a href="{{ route('blog.category') }}" class="nav-link dropdown-toggle"
                                    data-toggle="dropdown" role="button" aria-haspopup="true"
                                    aria-expanded="false">Categories</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="{{ route('blog.index') }}">Food</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('blog.index') }}">Business</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{ route('blog.index') }}">Travel</a>
                                    </li>
                                </ul>
                            </li>
