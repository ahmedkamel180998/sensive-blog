    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="box_1620 container">
                ...
                <a class="navbar-brand logo_h" href="{{ route('blog.index') }}"><img src="{{ asset('assets') }}/img/logo.png" alt=""></a>
                ...
                <div class="navbar-collapse offset collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-center">
                        ...
                        <li class="nav-item submenu dropdown @yield('categories-active')">
                            <a href="{{ route('blog.category') }}" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-social">
                        @if (Auth::check())
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="btn dropdown-toggle d-flex align-items-center" data-toggle="dropdown" role="button"
